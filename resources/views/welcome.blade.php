...
<body>
    ...
    <Section id="works">
        ...
        <div class="works">
            ...
            <div class="works_text">
                ...
                <a class="btn reg" href="#">My Class</a>
            </div>
        </div>
    </Section>
        ...
        <div class="classes-sec">
                ...
                <h2>Pick a Class <br>Start Now!</h2>
                    <div class="class_split">
                        ...
                        <img src="{{url('/pics/transparent.svg')}}" alt="">
    ...
    <Section id="subscribe">
        <div class="sub_content">
            ...
            <div class="subs">
                <input class="sub_box" type="email" name="" value="Enter Your email" id="email">
                <a class="btn sub" href="#" type="submit">Subscribe</a>
            </div>
        </div>
    </Section>
    ...
    <Section id="contact">
        <div class="contact_wrap">
            ...
            <form class="contact">
                <input type="text" name="name" value="Full name" id="" required><br>
                <input type="email" name="email" value="Email" id="" required><br>
                <input type="text" name="message" value="Message" id="" required><br>
                <a class="btn sub" href="" type="submit">Send</a>
            </form>
        </div>
    </Section>
